  ...
  return (
    <svg className={styles.thriveLogo} xmlns='http://www.w3.org/2000/svg' viewBox='0 0 757.4 387.5'>
      ...
      <g className={styles.thriveType}>
        <polygon  points='225,188.3 159.9,188.3 159.9,193.7 225,193.7 225,253.4 230.6,253.4 230.6,132.2 225,132.2 		'/>
        <rect x='130.2' y='132.2' width='5.6' height='121.2'/>
        <rect y='132.2' width='94.8' height='5.4'/>
        <rect x='44.6' y='161.1' width='5.6' height='92.3'/>
        <path d='M331,213.6c23,0,41.8-18.3,41.8-40.7s-18.8-40.7-41.8-40.7h-52.1v121.2h5.6V137.6H331
        c20.1,0,36.3,15.7,36.3,35.3c0,19.5-16.2,35.3-36.3,35.3h-23.3l57.6,45.2h9.3l-51.5-39.8H331z'/>
        <rect x='631.3' y='188.3' width='55.8' height='5.4'/>
        <polygon points='601.5,132.2 601.5,253.4 687.1,253.4 687.1,248 607.1,248 607.1,137.6 687.1,137.6 687.1,132.2'/>
        <rect x='411.9' y='132.2' width='5.6' height='121.2'/>
        <polygon points='510.4,244.3 457,132.2 450.9,132.2 509.5,255.2 511.3,255.2 569.9,132.2 563.7,132.2 '/>
      </g>
