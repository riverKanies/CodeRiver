        ...
        <section className={styles.socialColumn}>
          ...
          <div className={styles.socialIcons}>
            ...
            <Link to="https://www.instagram.com/ariannahuff/?hl=en">
              <svg className={styles.icon} version='1.1' xmlns='http://www.w3.org/2000/svg' width="20" height="20" viewBox="0 0 32 32" fill="#838d8f">
            ...
            <Link to='https://medium.com/@ariannahuff'>
              <svg className={styles.icon} version='1.1' xmlns='http://www.w3.org/2000/svg' width='20' height='20' viewBox='0 0 28 28' fill='#838d8f'>
