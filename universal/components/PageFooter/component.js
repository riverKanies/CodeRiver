	    ...
	    <div className={styles.container}>
	    	...
	    	<section className={styles.socialColumn}>
		      ...
		      <div className={styles.socialIcons}>
		      	<Link to='#'>
		      		<svg className={styles.icon} xmlns="http://www.w3.org/2000/svg" width="8.219" height="17.88" viewBox="0 0 8.219 17.88">
            ...
            <Link to='#'>
		      		<svg className={styles.icon} xmlns="http://www.w3.org/2000/svg" width="21.876" height="15.66" viewBox="0 0 21.876 15.66">
